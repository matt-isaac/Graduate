    ...
    \hlkwd{tabsetPanel}\hlstd{(}
      ...
      \hlkwd{tabPanel}\hlstd{(}\hlstr{"User Guide"}\hlstd{,}
               ...
               \hlkwd{h5}\hlstd{(}\hlstr{"UQViz is an interactive tool that can be used 
                  ...
                  information on 2D UQ, see "}\hlstd{,}
                  \hlstd{tags}\hlopt{$}\hlkwd{a}\hlstd{(}\hlkwc{href} \hlstd{=} \hlstr{"http://verification.asmedigitalcollection.asme.org/article.aspx?articleid=2703289&resultClick=1"}\hlstd{,}
      ...
      \hlkwd{tabPanel}\hlstd{(}\hlstr{"References"}\hlstd{,}
               ...
               \hlstd{tags}\hlopt{$}\hlkwd{div}\hlstd{(tags}\hlopt{$}\hlkwd{ul}\hlstd{(}
                 ...
                 \hlstd{tags}\hlopt{$}\hlkwd{li}\hlstd{(tags}\hlopt{$}\hlkwd{span}\hlstd{(tags}\hlopt{$}\hlkwd{a}\hlstd{(}
                   \hlkwc{href} \hlstd{=} \hlstr{"https://cran.r-project.org/web/packages/shiny/index.html"}\hlstd{,}
                   \hlkwc{target}\hlstd{=}\hlstr{"_blank"}\hlstd{,}
                   \hlstr{"shiny"}\hlstd{))),}
                 \hlstd{tags}\hlopt{$}\hlkwd{li}\hlstd{(tags}\hlopt{$}\hlkwd{span}\hlstd{(tags}\hlopt{$}\hlkwd{a}\hlstd{(}
                   \hlkwc{href} \hlstd{=} \hlstr{"https://cran.r-project.org/web/packages/ggplot2/index.html"}\hlstd{,}
                   \hlkwc{target}\hlstd{=}\hlstr{"_blank"}\hlstd{,}
                   \hlstr{"ggplot2"}\hlstd{))),}
                 \hlstd{tags}\hlopt{$}\hlkwd{li}\hlstd{(tags}\hlopt{$}\hlkwd{span}\hlstd{(tags}\hlopt{$}\hlkwd{a}\hlstd{(}
                   \hlkwc{href} \hlstd{=} \hlstr{"https://cran.r-project.org/web/packages/shinyWidgets/index.html"}\hlstd{,}
                   \hlkwc{target}\hlstd{=}\hlstr{"_blank"}\hlstd{,}
                   \hlstr{"shinyWidgets"}\hlstd{))),}
                 \hlstd{tags}\hlopt{$}\hlkwd{li}\hlstd{(tags}\hlopt{$}\hlkwd{span}\hlstd{(tags}\hlopt{$}\hlkwd{a}\hlstd{(}
                   \hlkwc{href} \hlstd{=} \hlstr{"https://cran.r-project.org/web/packages/shinydashboard/index.html"}\hlstd{,}
                   \hlkwc{target}\hlstd{=}\hlstr{"_blank"}\hlstd{,}
